...
export default function LoginPage() {
  ...
  return (
    <Layout>
      <div style={{ minHeight: '72vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(to bottom right, #f7fafc, #edf2f7)', padding: '1rem' }}>
        <div style={{ backgroundColor: '#ffffff', borderRadius: '0.75rem', padding: '2rem', maxWidth: '28rem', width: '100%', boxShadow: '0 10px 15px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {/* Email Field */}
            <div>
              <label htmlFor="email" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: '#4a5568', marginBottom: '0.25rem' }}>Email Address</label>
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: '#4a5568', marginBottom: '0.25rem' }}>Password</label>
            ...
            {/* Options */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.875rem', color: '#718096' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <input type="checkbox" style={{ accentColor: '#4a90e2' }} /> Remember me
              </label>
              <a href="#" style={{ color: '#3182ce', textDecoration: 'none' }}>Forgot password?</a>
            </div>
